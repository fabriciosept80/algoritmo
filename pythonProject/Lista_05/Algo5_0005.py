#Questão E. Na pacata vila campestre de Ponteironuloville, todos os telefones têm 6 dígitos. A companhia telefônica
# estabelece as seguintes regras sobre os números:
...
valor = []
valor1 = []
valor.extend(consec(base))
valor1.extend(par(valor))
print('*'*45)
print('Números Válidos'.center(43))
print()
print(f'São válidos \033[1;34m{len(fl(valor1))}\033[m números da lista !!!')
